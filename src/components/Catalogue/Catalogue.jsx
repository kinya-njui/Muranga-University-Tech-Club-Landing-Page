...
function CatlogueCard({thumbnail, title, description}) {
    return(
    ...
    return (
      <section className='catalogue-section'> 
        ...
        <div className="catalogue-cards-container">
           <CatlogueCard thumbnail={Person1} title="Dr. John Ndia" description="Patron of the club. Passionate about technology education."/> 
        </div>
      </section>
    )
  }
